...
// To determine how the items in the container we create from Class unordered_multiset will be arranged
class Hash
{
  public:
...
int main()
{
    unordered_multiset<int, Hash> nums = {6, 34, 72, 3, 1, 123, 34, 55, 3, 100, 2020};
