...
void printSet(const set<T, order> &container)
{
    cout << "{";
...
void reversePrinting(const set<int> &container)
{
    cout << "{";
...
int main()
{
    set<int> nums = {4, 3, 2, 1, 4, 1, 5, 2};
    set<int> oddNums = {1, 3, 5, 7, 9, 11};
    set<int, greater<int>> descendingNums = {10, 40, 20, 40, 50, 30, 10, 50};
